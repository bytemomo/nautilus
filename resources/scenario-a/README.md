...
**CRITICAL:** The insecure profile includes a CVE replay campaign that can crash the target broker.

```bash
# WARNING: Execution will cause service denial (CVE-2024-8376)
docker compose up -d
# Run the CVE replay campaign
```
