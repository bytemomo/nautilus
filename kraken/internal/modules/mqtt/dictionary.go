...
func runMQTTDictionaryAttack(ctx context.Context, mod *domain.Module, target domain.HostPort, res native.Resources, params map[string]any, timeout time.Duration) (domain.RunResult, error) {
