...
int fuzz_mqtt_parser(const uint8_t *data, size_t size) {
    ...
    /*
     * Use the MQTT-aware allocator so the message has MQTT proto_data
     * attached; this is the intended way to prepare a message that will
     * be passed to nng_mqtt_msg_decode(). :contentReference[oaicite:1]{index=1}
     */
